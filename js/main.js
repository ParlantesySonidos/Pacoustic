...
/** Redes oficiales — sustituir por la página o perfil público real de cada red. */
...
const _SOCIAL_ICONS = {
  facebook: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="20" height="20" aria-hidden="true" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M18 2h-3a5 5 0 0 0-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 0 1 1-1h3z"/></svg>',
  instagram: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="20" height="20" aria-hidden="true" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="2" y="2" width="20" height="20" rx="5" ry="5"/><path d="M16 11.37A4 4 0 1 1 12.63 8 4 4 0 0 1 16 11.37z"/><line x1="17.5" y1="6.5" x2="17.51" y2="6.5"/></svg>',
  tiktok: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="20" height="20" aria-hidden="true" fill="currentColor"><path d="M19.59 6.69a4.83 4.83 0 0 1-3.77-4.25V2h-3.45v13.67a2.89 2.89 0 0 1-5.2 1.74 2.89 2.89 0 0 1 2.31-4.64 2.93 2.93 0 0 1 .88.13V9.4a6.84 6.84 0 0 0-1-.05A6.33 6.33 0 0 0 5 20.1a6.34 6.34 0 0 0 10.86-4.43v-7a8.16 8.16 0 0 0 4.77 1.52v-3.4a4.85 4.85 0 0 1-1-.1z"/></svg>'
};

function buildSocialLinksHtml() {
  const rows = [
    { href: SOCIAL_FACEBOOK, label: 'Facebook', cls: 'social-link--fb', icon: _SOCIAL_ICONS.facebook },
    { href: SOCIAL_INSTAGRAM, label: 'Instagram', cls: 'social-link--ig', icon: _SOCIAL_ICONS.instagram },
    { href: SOCIAL_TIKTOK, label: 'TikTok', cls: 'social-link--tt', icon: _SOCIAL_ICONS.tiktok }
  ];
  return rows.map(({ href, label, cls, icon }) =>
    `<a class="social-link ${cls}" href="${escapeAttr(href)}" target="_blank" rel="noopener noreferrer" aria-label="P.Acoustic en ${escapeAttr(label)}">${icon}</a>`
  ).join('');
}

function applySocialLinks() {
  const html = buildSocialLinksHtml();
  ['socialLinksContact', 'socialLinksFooter', 'socialLinksNav'].forEach(id => {
