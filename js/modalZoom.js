...
function modalZoomInit() {
    ...
    img.addEventListener("wheel", _mzWheel, {
        passive: false
    });
...
function _mzWheel(e) {
    ...
    MODAL_ZOOM_CONFIG.currentZoom = Math.max(MODAL_ZOOM_CONFIG.minZoom, Math.min(MODAL_ZOOM_CONFIG.maxZoom, MODAL_ZOOM_CONFIG.currentZoom + d));
    const img = document.getElementById("modalImgMain");
